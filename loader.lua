...
function Engine:CreateTab(name, isDefault)
    ...
    TabButton.MouseButton1Click:Connect(function()
        ...
        Page.Visible = true
        TweenService:Create(TabButton, Theme.FastTween, {BackgroundTransparency = 0, TextColor3 = Theme.TextMain}):Play()
    end)

    -- Вспомогательная функция для заголовков групп (например, "Main", "Auto Collect")
